...
$Y_{1i}-Y_{0i}$
此處Y_{1i}為可通過限制學生的個經PR，Y_{0i}為沒有通過限制的學生的個經PR，兩個相減為具有通過限制資格學生的個經PR效果。
...
i泛指任何人，此處Y_i泛指學生的個經PR，Y_{1i}為可通過限制學生的個經PR，Y_{0i}為沒有通過限制的學生的個經PR，兩個相減為具有通過限制資格學生的個經PR效果。
(Y_{1i}-Y_{0i})T_i代表通過限制的學生（T=1），該學生的個經PR為未通過限制學生的效果加上通過限制學生的效果。反之，若未通過限制的學生（T=0），則該學生的個經PR為只有未通過限制學生的效果。
...
\begin{align}
先證明分子：
\frac{\sum_{i,x_i=1}^N (1-\frac{N_1}{N})(y_i-\bar{y})+{\sum_{i,x_i=0}^N(0-\frac{N_1}{N})(y_i-\bar{y})}
&=\frac{N_0}{N}\sum{i,x_i=1}^N(y_i-\bar{y})-\frac{N_1}{N}\sum_{i,x_i=0}(y_i-\bar{y})\\
&=\frac{N_0}{N}\sum_{i,x_i=1}y_i-\frac{N_0N_1}{N}\bar{y}-\frac{N_1}{N}\sum_{i,x_i=0}y_i+\frac{N_0N_1}{N}\bar{y}\\
&=\frac{N_0}{N}\sum_{i,x_i=1}y_i-\frac{N_1}{N}\sum_{i,x_i=0}y_i\\
\end{align}
